      ...
      >
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-700">
          ...
          <button
            ...
            className="text-gray-500 dark:text-gray-300 transition dropdown-toggle dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
          >
            <svg
              className="fill-current"
              width="24"
          ...
          <li>
            ...
            >
              ...
              <span className="block">
                ...
                <span className="flex items-center gap-2 text-gray-500 dark:text-gray-300 text-theme-xs dark:text-gray-400">
                  <span>Project</span>
